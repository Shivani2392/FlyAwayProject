...
//Register new Admin
	List<String> emailArrcheck=	session1.createQuery("select u.ADMINEMAIL from AdminRegistrationEntity u where u.ADMINEMAIL = '"+adminemail+"'").getResultList();
    ...
    htmlRespone += "<h2>Admin Registered succesfully!!...Admin can login now!!"+"</h2>";     
    htmlRespone += "<a href=AdminLogin.jsp>AdminLogin"+"</a>";    
